      ...
      <div>
        ...
        <div className="catagory-tab-wrapper">
          <div className="catagory-tab">
            ...
            <div className={this.props.ctgSort == "scene" ? "catagory-tab-item active" : "catagory-tab-item"} onClick={this.props.SortToScene}>
            
              <div>场景分类</div>
            </div>
            <div className={this.props.ctgSort == "pro" ? "catagory-tab-item active" : "catagory-tab-item"} onClick={this.props.SortToPro}>
              <div>商品分类</div>
            </div>
            <div className={this.props.ctgSort == "shop" ? "catagory-tab-item active" : "catagory-tab-item"} onClick={this.props.SortToShop}>
              <div>精选店铺</div>
            </div>
          </div>
        </div>
        ...
        {/* 场景分类 */}
        <div className="catagory-scene" style={this.props.ctgSort == "scene" ? {display: "block"} : {display: "none"}}>
          {/* 对象 */}
        ...
        <div className="catagory-pro" style={this.props.ctgSort == "pro" ? {display: "flex"} : {display: "none"}}>
            <div className="catagory-pro-tab">
            
                {/* <div className="pro-tab-item active" onClick={(params) => { */}
                <div className={this.state.proType == "jx" ? "pro-tab-item active" : "pro-tab-item"} onClick={(params) => {
                    this.setState({
                        proType: "jx"
                    })
                }
                ...
                <div className={this.state.proType == "sw" ? "pro-tab-item active" : "pro-tab-item"} onClick={(params) => {
                    this.setState({
                        proType: "sw"
                    })
                }
                ...
                <div className={this.state.proType == "jj" ? "pro-tab-item active" : "pro-tab-item"} onClick={(params) => {
                    this.setState({
                        proType: "jj"
                    })
                }
                ...
                <div className={this.state.proType == "sm" ? "pro-tab-item active" : "pro-tab-item"} onClick={(params) => {
                    this.setState({
                        proType: "sm"
                    })
                }
                ...
                <div className={this.state.proType == "gy" ? "pro-tab-item active" : "pro-tab-item"} onClick={(params) => {
                    this.setState({
                        proType: "gy"
                    })
                }
        ...
        {/* 精选店铺*/}
        <div className="catagory-shop" style={this.props.ctgSort == "shop" ? {display: "block"} : {display: "none"}}>
            <div className="catagory-shop-wrap">
                <div className="catagory-shop-item">
                    ...
                    <div className="shop-item-right">
                        ...
                        <div className="shop-item-des">礼品定制服务，以诚信，热情服务获得大家一致认可</div>
                        <div className="shop-item-rec">推荐指数：9.8</div>
                    </div>
                </div>

                <div className="catagory-shop-item" style={{backgroundColor:"#EEEEEE"}}>
                    <div className="shop-item-left">
                        <img src="http://wlanya.oss-cn-shenzhen.aliyuncs.com/2020_08_25/40231e90-33a9-5b97-2662-dfe494d8fa34.png"></img>
                    </div>
                    <div className="shop-item-right">
